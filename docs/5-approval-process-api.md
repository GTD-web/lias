...
- `implementerId` (string UUID): 시행자 ID
...
```json
{
  ...
  "status": "IMPLEMENTED",
  "comment": "처리 완료했습니다.",
  "approvedAt": "2025-01-01T15:00:00.000Z",
  "createdAt": "2025-01-01T00:00:00.000Z",
...
```json
{
  "id": "doc-uuid-1",
  "status": "CANCELLED",
  "cancelReason": "내용 수정이 필요하여 취소합니다.",
...
```json
{
  "data": [
    {
      "documentId": "doc-uuid-1",
      "documentNumber": "VAC-2025-0001",
      "title": "2025년 1월 휴가 신청",
      "status": "PENDING",
      "drafterId": "emp-uuid-drafter",
      "drafterName": "이기안",
