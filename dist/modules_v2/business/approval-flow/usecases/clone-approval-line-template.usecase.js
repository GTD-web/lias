...
var CloneApprovalLineTemplateUsecase_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CloneApprovalLineTemplateUsecase = void 0;
const common_1 = require("@nestjs/common");
const approval_flow_context_1 = require("../../../context/approval-flow/approval-flow.context");
let CloneApprovalLineTemplateUsecase = CloneApprovalLineTemplateUsecase_1 = class CloneApprovalLineTemplateUsecase {
    constructor(approvalFlowContext) {
        this.approvalFlowContext = approvalFlowContext;
        this.logger = new common_1.Logger(CloneApprovalLineTemplateUsecase_1.name);
    }
...
exports.CloneApprovalLineTemplateUsecase = CloneApprovalLineTemplateUsecase;
exports.CloneApprovalLineTemplateUsecase = CloneApprovalLineTemplateUsecase = CloneApprovalLineTemplateUsecase_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [approval_flow_context_1.ApprovalFlowContext])
], CloneApprovalLineTemplateUsecase);
//# sourceMappingURL=clone-approval-line-template.usecase.js.map